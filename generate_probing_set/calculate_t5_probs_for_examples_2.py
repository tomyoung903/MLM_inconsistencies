...
input_sentence = "The <extra_id_0> is a common choice of food."
print(input_sentence)
input_ids = tokenizer(input_sentence, return_tensors="pt").input_ids
input_ids = input_ids.to('cuda:0')

labels_sentences = ["<extra_id_0> chicken burger <extra_id_1>", \
                    "<extra_id_0> chicken breast <extra_id_1>", \
                    "<extra_id_0> chicken salad <extra_id_1>", \
                    "<extra_id_0> chicken satay <extra_id_1>"]
probs = []
